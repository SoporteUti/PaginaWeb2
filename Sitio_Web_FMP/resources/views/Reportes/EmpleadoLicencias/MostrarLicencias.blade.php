            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="myCenterModalLabel">
                        <i class="mdi dripicons-information  mdi-24px" style="margin: 0px;"></i> Aviso
                    </h3>
    ...
    <div id="modalPDF" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="myCenterModalLabel">
                        <i class="mdi mdi-pdf-box   mdi-20px" style="margin: 0px;"></i> Aviso
                    </h3>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <form action="{{ route('Reporte/Licencias/empleado') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="anualesP" id="anualesP">
                        <input type="hidden" name="mensualesP" id="mensualesP">
            ...
            <div class="card-box">
                <div class="row py-2">
                    ...
                    <div class="col-lg-1 order-last">
                        ...
                        <button type="button" title="Descargar PDF" class="btn btn-success dripicons-document-remove"
                            id="descargarLicencias"></button>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-6">
                        <div class="form-group">
                            <label  for="mes"><p class="text-danger">Horas Anuales disponibles: </p></label>
                             <label id="anualesx"></label>
                        </div>
                    </div>

                    <div class="col-12 col-sm-6 col-md-6">
                        <div class="form-group">
                            <label for="anio"><p class="text-danger">Mensuales: </p></label>
                            <label id="mensualesx"></label
